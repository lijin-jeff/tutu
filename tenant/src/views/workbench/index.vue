            ...
            <el-card class="!border-none mb-4 lg:mr-4 lg:w-[350px]" shadow="never">
                ...
                <div>
                    <div class="flex leading-9">
                      ...
                      <span> <a :href="workbenchData.version.channel.website" target="_blank">{{ workbenchData.version.name }}</a></span>
                    </div>
                    <div class="flex leading-9">
                    ...
                    <div class="flex leading-9">
                        ...
                        <span>
                          <a :href="workbenchData.version.channel.gitee" target="_blank">Gitee</a>
                          <a :href="workbenchData.version.channel.github" target="_blank" style="margin-left: 10px;">Github</a>
                        </span>
                    </div>
                </div>
            </el-card>
...
const getData = () => {
    getWorkbench()
        .then((res: any) => {
            ...
            workbenchData.channel.gitee = res.channel.gitee
            workbenchData.channel.website = res.channel.website
