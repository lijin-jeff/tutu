    ...
    <div class="website-information">
        ...
        >
            ...
            <el-card shadow="never" class="!border-none mt-4">
                ...
                <el-form-item label="客服微信" prop="wechat_code">
                  <div class="w-80">
                    <el-input
                        v-model.trim="formData.wechat_code"
                        placeholder="请输入客户微信"
                        maxlength="30"
                        show-word-limit
                    ></el-input>
                ...
                <el-form-item label="客服电话" prop="service_phone">
                  <div class="w-80">
                    <el-input
                        v-model.trim="formData.service_phone"
                        placeholder="请输入客服电话"
                        maxlength="30"
                        show-word-limit
                    ></el-input>
                ...
                <el-form-item label="客户二维码" prop="service_qr_code" required>
                    <div>
                        <material-picker v-model="formData.service_qr_code" :limit="1" />
                        <div class="form-tips">建议尺寸：100*100像素，支持jpg，jpeg，png格式</div>
                    </div>
                </el-form-item>
                <el-form-item label="网站图标" prop="web_favicon" required>
