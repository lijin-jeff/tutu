...
return [
    // 系统版本号
    'version'               => '1.0.0',
    'project_name'          => '兔兔答题-SaaS版',

    // 官网
    'website'               => [
        'name'        => env('project.web_name', '兔兔答题'), // 网站名称
        'url'         => env('project.web_url', 'www.兔兔答题.cn/'), // 网站地址
        'shop_name'   => '兔兔答题', // 商城名称
        ...
        'pc_title'    => '兔兔答题', // PC网站标题
        'pc_keywords' => '兔兔答题,后台管理系统', // PC网站关键词
        'pc_desc'     => '永久免费开源的兔兔答题通用前后端分离管理后台系统', // PC网站描述
    ...
    // 唯一标识，密码盐、路径加密等
    'unique_identification' => env('project.unique_identification', '兔兔答题'),
    ...
    // 列表页
    'lists'                 => [
        'page_size_max' => 20,//列表页查询数量限制（列表页每页数量、导出每页数量）
        'page_size'     => 20, //默认每页数量
    ],
