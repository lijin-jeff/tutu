...
class UserLogic
{
    ...
    public static function getConfig(): array
    {
        ...
        $defaultNickname = config('project.default_nickname');
        $config          = [
            //默认头像
            'default_avatar'   => FileService::getFileUrl(ConfigService::get('default_image', 'user_avatar', $defaultAvatar)),
            'default_nickname' => ConfigService::get('default_nickname', 'user_nickname', $defaultNickname),
        ];
        return $config;
    }
    ...
    public function setConfig(array $params): bool
    {
        ...
        ConfigService::set('default_nickname', 'user_nickname', $params['default_nickname']);
        return true;
    }
