...
class WeChatPayService extends BasePayService
{
     ...
     * @date 2021/8/4 15:05
     */
    public function pay($from, $order): bool|array|string
    {
        try {
    ...
    public function appPay($from, $order, $appId)
    {
        ...
        // 生成签名
        $sign = $this->generateSign($appId, $timeStamp, $nonceStr, $package, $signType);
     ...
     * @return string
     */
    private function generateSign($appId, $timeStamp, $nonceStr, $package, $signType): string
    {
        print_r($this->config);
