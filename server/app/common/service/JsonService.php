...
class JsonService
{
     ...
     * @date 2021/12/24 18:28
     */
    public static function fail(string $msg = 'fail', array $data = [], int $code = 0, int $show = 1, int $httpCode = 200): Json
    {
        return self::result($code, $show, $msg, $data, $httpCode);
    }
    ...
    {
        return self::success('请求成功', $data, 1, 0);
    }
     ...
     * @date 2021/12/24 18:29
     */
    public static function throw(string $msg = 'fail', array $data = [], int $code = 0, int $show = 1, $httpStatus = 200): Json
    {
        $data     = compact('code', 'show', 'msg', 'data');
        $response = Response::create($data, 'json', $httpStatus);
