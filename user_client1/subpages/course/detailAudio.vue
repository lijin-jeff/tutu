<template>
	<view class="template-news tn-safe-area-inset-bottom">
		...
		<view class="tl-video" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
			<view class="audio-play-container">
				<my-audio @audioDownload="audioDownload" :autoplay="playStatus" :isShareBtn="false"
					@audioCollec="audioCollectionAction" @audioShare="audiShareAction" :isCollectBtn="false" isCountDown
					@audioPlay="audioStartPlay" @audioPause="audioStopPlay" @audioEnd="audioStopPlay" :titleScroll="false"
					ref="audio" :src="courseContent.src"></my-audio>
			</view>
		</view>
	...
	export default {
		...
		data() {
			return {
				...
				playTitle: '', // 音视频播放标题
				playStatus: true, // 音视频是否自动播放
				courseContent: {
					title: 'PHP是世界上最好的编程语言是世界上最好的编程语言是世界上最好的编程语言',
					src: 'http://cdn.image.tutudati.com/tldemo.mp3',
				},
				resourceList: [{
					uid: '',
...
<style lang="scss" scoped>
	...
	.audio-play-container {
		...
		height: 100%;
		color: #FFF !important;
		background-image: url('https://cdn.image.tutudati.com/audio_demo.gif');
