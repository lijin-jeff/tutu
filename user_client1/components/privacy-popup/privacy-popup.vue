<template>
	<view v-if="showPrivacy" class="privacy">
		<view class="content">
			...
			<view class="des">
				在使用当前小程序服务之前，请仔细阅读
				<text class="link" :style="{color: mainColor}" @tap="openPrivacyContract">{{privacyContractName}}</text>
				。如你同意{{privacyContractName}}，请点击“同意”开始使用。
			</view>
			<view class="btns">
				<button class="item reject" @tap="exitMiniProgram">拒绝</button>
				<button id="agree-btn" class="item agree" open-type="agreePrivacyAuthorization"
					@agreeprivacyauthorization="handleAgreePrivacyAuthorization" :style="{backgroundColor: mainColor}">同意</button>
			</view>
		</view>
	</view>
</template>
