	...
	<view class="page-e tn-safe-area-inset-bottom">
		...
		<view class="tn-margin-left tn-margin-right" :style="{paddingTop: vuex_custom_bar_height + 10 + 'px'}">
			...
			<view class="tn-flex tn-flex-row-between tn-flex-col-center tn-margin-bottom" style="margin-top: -450rpx;">
				<view class="justify-content-item">
					<view class="tn-flex tn-flex-col-center tn-flex-row-left">
						...
						<view class="tn-padding-right">
							...
							<view class="tn-padding-right tn-padding-top-xs tn-padding-left-sm tn-text-ellipsis" @click="copyUid">
				...
				<view class="justify-content-item" @click="tn('/subpages/user/set')" v-if="user.code != ''">
				...
				<view class="tn-flex tn-flex-row-center tn-radius tn-padding-top">
					...
					<view class="tn-padding-sm tn-margin-xs tn-radius" @click="tn('')">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis">答题历史</text>
							</view>
						</view>
					</view>
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			copyUid() {
				this.$func.setClipboardData(this.userInfo.sn)
			},
			// 退出登录
			loginOut() {
