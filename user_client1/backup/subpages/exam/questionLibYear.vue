	...
	<view class="page tn-safe-area-inset-bottom">
		<tn-nav-bar fixed customBack :backgroundColor="mainColor">
			...
			<view class="tn-flex tn-flex-col-center tn-flex-row-center">
				<text class="tn-text-bold tn-text-xl tn-color-white">历年真题</text>
			</view>
		</tn-nav-bar>
		<view :style="{paddingTop: vuex_custom_bar_height + 'px'}">
			...
			<view class="exam-ul">
				<block v-for="(it, index) in newsList" :key="index">
					<view class="tn-flex exam-li mt-10" @click="tl('/subpages/exam/questionOrder?uid=' + it.uid)">
