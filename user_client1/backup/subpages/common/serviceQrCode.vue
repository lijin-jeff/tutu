		...
		<view :style="{paddingTop: vuex_custom_bar_height + 'px'}">
			<view class="customer-service-container tn-margin-lg tn-padding-lg">
				...
				<view class="qrcode-container" @click="imagePreview">
					<image class="qrcode-image" src="/static/image/service.png" mode="aspectFit"></image>
				</view>

				<view class="service-info">
					<text class="service-text">长按添加客服或拨打客服热线</text>
					<text class="service-phone" @tap="callService">18578768757</text>
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			imagePreview() {
				this.$func.previewImage('/static/image/service.png')
			}
		}
	}
</script>
